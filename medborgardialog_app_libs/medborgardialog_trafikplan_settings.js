    ...
    app: {
        trafikplan: {
            ...
            alltexts: {
				...
				mapPositionDoneButtonMerInfoText_defaultPosition: "Du har inte lagt till någon kartposition. Så en standard kartposition läggs automatiskt till Rådhus. Men du har möjlighet att ändra kartpositionen.",                
                ...
                warningNotWrittingComments: "Du har inte skrivit någon synpunkt eller namn."


            },
            layers: {
                medborgerdialog_trafikplan_p: {
                    init: "L.TileLayer.WMS",
                    url: "/kkartor/park_besiktning_handlers/bypass_parkbesiktning.php?park_img=/med_trafikplan_qgis/?DPI=96&gutters=500:20",
                    maplink: "",
                    options: {
                        tiled: !0,
                        tileSize: 512,
                        layers: "medborgerdialog_trafikplan_p",
                        minZoom: 0,
                        maxZoom: 12,
                        category: ["Utbildning & barnomsorg"],
                        displayName: "medborgerdialog",
                        layerId: "medborgerdialog_trafikplan_p",
                        project: "kkarta_r",
                        inputCrs: "EPSG:3857",
                        selectable: !0,
                        selectOptions: {
						...
						defaultPosition: {
						   enable:true,
						   lat: "56.03105671805727",
						   lng: "14.153292775154114"
					    },	
                        editable: !0,
                        editOptions: {
                            editPanelName: "",
                            ...
                            sending_email: {
                                enable: true,
                                mail_service: "/kkartor/park_besiktning_handlers/sendmail/sendmail_to_plan_admin_trafik.php",
                                admin_mail_address: "",
                                plan_admin_mail_adress: "planadm@kristianstad.se",
								//plan_admin_mail_adress: "mohammad.amin@kristianstad.se",
                                plan_admin_mail_subject: "E-post från medborgardialog trafikplan applikation",
                                plan_admin_mail_body: "Nedan synkpunkt kommer från medborgardialog trafikplan applikation: "
                            },
                            password: !1,
                            url: "/kkartor/park_besiktning_handlers/med_trafikplan_pov.php",
